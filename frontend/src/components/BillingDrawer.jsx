...
export default function BillingDrawer({
  ...
  const handleUpgrade = async (plan) => {
    ...
    try {
      ...
      // Payment is verified and the session's credits/plan were updated
      // server-side, but the client's Redux store still has the old
      // values — refetch so the UI (credit bar, plan badge) reflects it
