...
const toggleMic = () => {
  ...
  const handleSend = async () => {
    if (isLoading) return; // a request is already in flight — the Send
    // button's icon swaps to a stop-square while loading, but there's no
    // wired-up cancel/abort, so without this guard clicking it again just
    // fired a second, concurrent request instead of stopping anything.
