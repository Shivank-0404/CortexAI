...
const [showBilling, setShowBilling] =useState(false);
  ...
  const handleSelectConversation = (conversation) => {
    ...
    // MessageList's own effect (keyed on selectedConversation._id) fetches
    // this conversation's messages and derives its artifacts correctly —
    // doing it again here duplicated the request and, since `getMessages`
    // returns a plain array (no `.artifacts` field), was clearing the
    // artifact panel every time depending on which fetch resolved last.
  };
