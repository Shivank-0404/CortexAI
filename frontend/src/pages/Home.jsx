...
const login=async (token)=>{
  ...
  const handleGoogleLogin =async () => {
     ...
     const isMock = !apiKey || apiKey.startsWith("add ") || apiKey.startsWith("Add ");
     if (isMock) {
       console.log("[Mock Mode] Bypassing Google login and using mock token");
       await login("mock-firebase-uid");
     } else {
       try {
         const result =
