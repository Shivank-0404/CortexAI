...
// Internal service-to-service routes must never be reachable through the
// public gateway, even though the auth service also guards them with a
// shared secret. This blocks them before they ever get proxied.
